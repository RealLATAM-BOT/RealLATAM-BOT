...
export async function handler(chatUpdate) {
  ...
  /* Creditos a SoyYosser (https://wa.me/+
  584129605248) */
  ...
  try {
    ...
    try {
      ...
      /* Creditos a SoyYosser (https://wa.me/584129605248) */
  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;SoyYosser 👑;;;\nFN:SoyYosser 👑\nORG:SoyYosser 👑\nTITLE:\nitem1.TEL;waid=584129605248:+584 1296 05248\nitem1.X-ABLabel:SoyYosser 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:SoyYosser 👑\nEND:VCARD`;
        await mconn.conn.sendMessage(nk.from, {contacts: {displayName: 'SoyYosser 👑', contacts: [{vcard}]}}, {quoted: callmsg});
...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*[ ⚠ ] Advertencia*', body: 'ᴛʜᴇ ᴍʏsᴛɪᴄ - ʙᴏᴛ', thumbnail: imagen1, sourceUrl: 'https://github.com/RealLATAM-BOT/RealLATAM-BOT'}}}}, aa);
